...
print(f"Olá, {convidados[0]}. Você está convidado para um jantar em minha casa.")
print(f"Olá, {convidados[1]}. Você está convidado para um jantar em minha casa.")
print(f"Olá, {convidados[2]}. Você está convidado para um jantar em minha casa.")